    ...
    <footer className="bg-[#1675ab] text-white">
      ...
      <div className="container mx-auto px-16 py-12 flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="mx-6 md:mb-0">
          ...
          {/* Motivational Text */}
          <p className="mt-4 text-sm max-w-xs pt-5">
            Your journey to success starts with knowledge. Keep striving, keep
            achieving!
          </p>
        </div>
        ...
        <div className="mx-6 my-6 lg:mx-6 lg:my-0">
          ...
          <div className="space-y-2">
            ...
            <p>Email: info@infographytech.com</p>
          </div>
      ...
      {/* Copyright Bar */}
      <div className="border-t border-white-800 py-4 text-center text-sm">
